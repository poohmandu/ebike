...
/**
 * Description: 
 * date: 2020/1/8 1:03 AM
 * @author niezhao
 * @version
 * @since JDK 1.8
 */
@FeignClient(name = "third", contextId = "hmb")
public interface HmbService {

    @PostMapping(ApiRoute.Third.Hmb.insure)
    InsuranceRecordDto insure(@RequestBody InsuranceParam param);

    @PostMapping(ApiRoute.Third.Hmb.identifyIdCard)
